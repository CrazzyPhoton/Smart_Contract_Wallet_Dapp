...
contract Wallet is ERC721Holder, ERC1155Holder {
    ...
    /// @notice Function allows this contract to directly receive native token.
    receive() external payable virtual {}

    /// @notice Function allows manually depositing to this contract.
    function deposit() external payable {
        require(msg.value > 0, "Amount sent must be greater than zero");
    }

    /**
     * @notice Function withdraws amount from this contract to the recipient.
     *         Smart contract owner only function.
     *
     * @param recipient The address of the recipient who will receive the amount.
     * @param amount    The amount the recipient will rececive.
     */
